(function ($) {
  ...
  if ($("#Product-one__thumb").length) {
    let testimonialsThumb = new Swiper("#Product-one__thumb", {
      slidesPerView: 4,
      spaceBetween: 16,
      speed: 1400,
    ...
    let testimonialsCarousel = new Swiper("#Product-one__carousel", {
      observer: true,
      observeParents: true,
      loop: true,
      speed: 1400,
      ...
      "navigation": {
        "nextEl": "#Product-one__swiper-button-next",
        "prevEl": "#Product-one__swiper-button-prev"
      },
  ...
  // ===Portfolio===
  function ProductMasonaryLayout() {
